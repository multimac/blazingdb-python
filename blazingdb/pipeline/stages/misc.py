...
class DelayStage(custom.CustomActionStage):
    ...
    def __init__(self, delay, **kwargs):
        super(DelayStage, self).__init__(self._delay, [messages.ImportTableMessage], **kwargs)
...
class PromptInputStage(custom.CustomActionStage):
    ...
    def __init__(self, **kwargs):
        super(PromptInputStage, self).__init__(self._prompt, [messages.ImportTableMessage], **kwargs)
        self.prompt = kwargs.get("prompt", "Waiting for input...")
...
class SkipImportStage(base.BaseStage):
    ...
    def __init__(self):
        super(SkipImportStage, self).__init__(messages.ImportTableMessage)
...
class SkipTableStage(base.BaseStage):
    ...
    def __init__(self, included=None, excluded=None):
        super(SkipTableStage, self).__init__(messages.ImportTableMessage)
